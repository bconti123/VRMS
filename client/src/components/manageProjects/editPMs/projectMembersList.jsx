...
import { Box, Grid, List, ListItem, ListItemButton, Modal, Typography } from '@mui/material';
    ...
    <Grid>
                  ...
                  >
                    <Grid item>
                      <Typography fontWeight="bold" color="black">
                        {name.firstName.toUpperCase() + ' ' + name.lastName[0].toUpperCase() + '.'}
                      </Typography>
                    </Grid>
                    <Grid item>
                    ...
                    {/* Remove Modal */}
                    <Modal open={openModal} hideBackdrop={true}>
                      <Box sx={modalStyle2}>
                        ...
                        <ButtonGroup
                          btnName1={'Yes'}
                          btnName2={'No'}
                          callBackFn1={handleRemoveConfirm}
                          callBackFn2={() => {
                            setSelectedUserId('');
                            setOpenModal(false);
                          }}
                    ...
                    <Modal open={removeConfirmModal} hideBackdrop={true}>
                      <Box onClick={() => setRemoveConfirmModal(false)} sx={modalStyle1}>
                    ...
                    <Grid container direction="column">
                      <Grid item>
                        <Typography
                          ...
                          sx={{ whiteSpace: 'normal', wordBreak: 'break-word', color: 'black' }}
                        >
      ...
      {editMode && (
        <ButtonGroup
          btnName1={'Save'}
          btnName2={'Close'}
          callBackFn1={handleSavePMs}
          callBackFn2={handleClosePMs}
          isLoading={isLoading}
        />
      )}
      ...
      >
        <Box sx={modalStyle2}>
          ...
          <ButtonGroup
            btnName1={'Yes'}
            btnName2={'No'}
            callBackFn1={handleCloseOnYes}
            callBackFn2={handleCloseOnNo}
            isLoading={isLoading}
          />
        </Box>
      </Modal>
