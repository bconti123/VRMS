...
const generateReports = (results, exitCode) => {
  ...
  console.log(`Found ${results.length} files with linting errors. Total written to ${countFile}`);
...
try {
  ...
  try {
    ...
    console.error('Failed to parse ESLint output. The output was not valid JSON.');
